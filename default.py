...
ADDON=xbmcaddon.Addon(id='plugin.video.SimpleKodiWizard')
dialog = xbmcgui.Dialog()    
VERSION = "1.0.0"
PATH = "SimpleKodiWizard"            

    
def CATEGORIES():
    link = OPEN_URL('http://dmonsterbuild.comuf.com/Wizard/wizard.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=aqua]Simple Kodi Wizard[/COLOR]","[COLOR=red]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
